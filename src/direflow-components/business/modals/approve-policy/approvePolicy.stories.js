...
export default {
  title: 'Design System/Business/Modals/ApprovePolicy',
  ...
  argTypes: {
    ...
    apmPolicy: {
      control: "object",
      description: "sets the apmPolicy value",
      table: {
        category: 'Element'
      }
    },
...
export const approvePolicyModal = Template.bind({});
approvePolicyModal.args = ApprovePolicyArgs;
