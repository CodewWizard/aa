    ...
    controls: [
      {
        ...
        props: {
          ...
          rows: "4",
          cols: "50",
          placeholder: "Please enter Remarks (Max 200 characters)",
          maxlength: "200",
        },
...
const onBlur = (model, key) => {
  console.log("Blur", model, key);
};

const onFormSubmit = (model) => {
  console.log("Sumbit", model);
};

const OnRejectOnHoldArgs = {
  showOnReject: true,
  showOnHold: true,
  buttonName: "Reject policy",
  submitLabel: "Submit",
  closeLabel: "Close",
  showModal: true,
  setShowModal: () => {},
  formModel: rhmPolicy,
  formSchema: onHoldModel,
  onClose: () => {},
  onFormSubmit: (model) => {
    onFormSubmit(model);
  },
...
export default {
  title: "Design System/Business/Modals/OnRejectOnHold",
  ...
  argTypes: {
    ...
    showModal: {
      control: "object",
      description: "set hold /reject type to show and hide modal.",
      table: {
        category: "Element",
      },
    },
...
const Template = (args) => <OnRejectOnHold {...args} />;
export const onRejectOnHoldModal = Template.bind({});
onRejectOnHoldModal.args = OnRejectOnHoldArgs;
