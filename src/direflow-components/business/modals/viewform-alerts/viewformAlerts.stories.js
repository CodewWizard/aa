...
export default {
  title: 'Design System/Business/Modals/ViewFormAlerts',
  ...
  argTypes: {
    ...
    vfamSummary: {
      control: "object",
      description: "sets the vfamSummary value",
      table: {
        category: 'Element'
      }
    },
    ...
    handleViewforms: {
      action: (e) => { console.log(e); },
      description: "Handle View Forms event",
      table: {
        category: 'Events'
      },
    },
...
export const viewFormAlertsModal = Template.bind({});
viewFormAlertsModal.args = ViewFormAlertsArgs;
